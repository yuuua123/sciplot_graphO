...
/**
 * Функция, которая рисует гистограмму со средними задержками перед нажатием каждой из клавиш в порядке возрастания.
 *
 * @param delays : Словарь со средними задержками, формат которого описан в функции `getDelays()`
 */
